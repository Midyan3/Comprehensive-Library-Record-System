...
class LibraryRecord : public ArrayBag<Book*>{
  public:
    ...
    **/
    LibraryRecord(std::string csv_file_name);
	  /**
	   * @brief Intiliazes the LibraryRecord with Book objects from a csv file
	   * 
	   * @param CSV file name 
	   */
    ...
    */
    ...
    grade_level grade_level_convertor(std::string grade_level);
    /**
     ...
     * @return int 
     */
    int string_to_int(std::string convert_me);
    /**
     * @brief Testers the LibraryRecord class
     * 
     */
    void tester();
    /**
     * @brief Displays all the books that match the key
     * 
     * @param key 
     */
